# TODO
## Fetcher
- [x] Auto detect new guild members
...
- [x] Leaderboard profit
- [x] Total value from chest
- [x] Spent on each floor
- [x] Loss report per player
- [x] Chest items value report per player
